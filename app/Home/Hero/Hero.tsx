...
const Hero: React.FC = () => {
  return (
    <section className="h-screen px-0">
      <div className="hero__background__container relative h-screen w-full overflow-hidden rounded-tl-[500px] border-4 border-l-[var(--main-theme)] border-t-[var(--main-theme)] max-rg_mobile:rounded-none max-rg_mobile:border-0">
        <Image
          src={reception}
          fill={true}
        ...
        <Reveal yTranslate={0} xTranslate={100}>
          <div className="dialog absolute bottom-24 right-8 flex w-[600px] flex-col items-center justify-start rounded-[50px] px-8 py-4 max-sm_desktop:bottom-32 max-sm_tablet:w-[400px] max-rg_mobile:bottom-[150px] max-rg_mobile:left-[50%] max-rg_mobile:w-[340px] max-rg_mobile:translate-x-[-50%]">
